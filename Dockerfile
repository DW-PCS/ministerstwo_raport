...
ARG NEXT_PUBLIC_ENABLE_MONTHLY_SECTIONS_IN_PDF_AND_DOCX
...
ENV NEXT_PUBLIC_ENABLE_MONTHLY_SECTIONS_IN_PDF_AND_DOCX=$NEXT_PUBLIC_ENABLE_MONTHLY_SECTIONS_IN_PDF_AND_DOCX
